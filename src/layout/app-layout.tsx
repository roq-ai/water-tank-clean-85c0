...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['cleaning-technician', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Requests', path: '/requests', entity: 'request', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Services', path: '/services', entity: 'service', service: AccessServiceEnum.PROJECT, icon: FiSettings },
