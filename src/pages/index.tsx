...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Water Tank Cleaning Services`}</title>

        <meta
          name="description"
          content="Experience Pure Cleanliness with Water Tank Cleaning Services - Your Premier Choice for Comprehensive Tank Cleaning and All-in-One Disinfection Solutions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579908195863-2a7b4307a8cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx3YXRlciUyMHRhbmt8ZW58MHx8fHwxNjk0NjY0OTAzfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@harrycunningham?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Harry Cunningham`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Pure Cleanliness with Water Tank Cleaning Services - Your Premier Choice for Comprehensive Tank Cleaning and All-in-One Disinfection Solutions.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Cleaning Technician"
                  type="cleaning-technician"
