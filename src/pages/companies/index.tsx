...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'representative.count', 'request.count', 'service.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('representative', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'representative',
          header: 'Representative',
          accessorKey: 'representative',
          cell: ({ row: { original: record } }: any) => record?._count?.representative,
        }
      : null,
    ...
    hasAccess('service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Service',
          accessorKey: 'service',
          cell: ({ row: { original: record } }: any) => record?._count?.service,
        }
      : null,
