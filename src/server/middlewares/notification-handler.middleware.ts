...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'request.create': {
    roles: ['cleaning-technician', 'customer-service-representative'],
    key: 'new-service-request',
    tenantPath: ['company', 'request'],
    userPath: [],
  },
  'request.update': {
    roles: ['cleaning-technician', 'customer-service-representative'],
    key: 'service-request-update',
    tenantPath: ['company', 'request'],
    userPath: [],
  },
  'request.delete': {
    roles: ['cleaning-technician', 'customer-service-representative'],
    key: 'service-request-cancel',
    tenantPath: ['company', 'request'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['cleaning-technician'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['cleaning-technician', 'customer-service-representative'];
